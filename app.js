...
// ============ MEDICIÓN EN TIEMPO REAL (IRI SIEMPRE VISIBLE) ============
function processAccelerometerData(verticalAccel) {
  ...
  // Fuerza IRI = 0 si el RMS es muy pequeño (reposo)
...
// ============ GARAJE, HISTORIAL, VISOR (se mantienen igual que en la última versión funcional) ============
// ... (todo el código de estas secciones, idéntico al que te entregué en la respuesta anterior)
// Por brevedad, incluyo aquí las funciones completas que ya estaban correctas.
