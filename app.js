...
function switchTab(tab) {
  ...
  // Ocultar todas las pestañas y la pantalla principal
  mainScreen.classList.add('hidden');
  historyTab.classList.add('hidden');
  globalTab.classList.add('hidden');
  
  // Desmarcar todos los botones de navegación
  ...
  // Si se pulsa el botón COCHE, no se hace nada especial porque abre el modal directamente
}
...
function selectVehicle(id){
  ...
  // Actualizar el botón COCHE con el nombre del vehículo
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  // Actualizar botón COCHE si ya hay vehículo seleccionado
