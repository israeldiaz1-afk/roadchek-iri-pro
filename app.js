...
function processAccelerometerData(verticalAccel) {
  ...
  // Almacenar para gráfico y actualizar ambos charts
...
function updateSegmentLabel(){const v=document.getElementById('segmentLengthSlider')?.value;if(v) document.getElementById('segmentLengthLabel').textContent=v+' m';}
...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  // Gráfico principal con colores dinámicos y escala automática
  ...
  // Cargar última ruta seleccionada por defecto
...
function toggleMapExpand() {
  ...
  if (!state.mapExpanded) {
    ...
    mapContainer.style.position = ''; mapContainer.style.top = ''; mapContainer.style.left = '';
    mapContainer.style.width = ''; mapContainer.style.height = '150px'; mapContainer.style.zIndex = '';
    state.mapExpanded = false;
  }
